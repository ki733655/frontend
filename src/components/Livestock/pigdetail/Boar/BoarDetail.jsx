      ...
      <div className="boar-detail-2nd">
        ...
        <Table className="boar-detail-table" responsive bordered hover>
          ...
          {boarData.map((value, index) => {
            const CSF = value.CSF
              ? new Date(value.CSF).toLocaleDateString("en-US")
              : "Null";
            const FMD = value.CSF
              ? new Date(value.FMD).toLocaleDateString("en-US")
              : "Null";
            const Deworm = value.CSF
              ? new Date(value.Deworm).toLocaleDateString("en-US")
              : "Null";
